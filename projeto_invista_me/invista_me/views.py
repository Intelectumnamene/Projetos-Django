...
from .models import Investimento #traz as informações que estão registradas no banco de dados e passa para a página (site)
...
def investimento_registrado(request):
    ivestimento = {"tipo_investimento": request.POST.get("TipoInvestimento")}
    return render(request, "investimentos/investimento_registrado.html", ivestimento)
